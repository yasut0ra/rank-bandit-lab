...
from rank_bandit_lab.visualize import (
...
class VisualizeDataTests(unittest.TestCase):
    def test_learning_curve_data_returns_series(self) -> None:
        ...
        self.assertEqual(data["optimal_reward"], [0.8, 0.8])
    ...
    def test_regret_curve_data(self) -> None:
        ...
        self.assertEqual(data["rounds"], [1, 2])
        self.assertAlmostEqual(data["instant_regret"][0], -0.2)
        self.assertAlmostEqual(data["cumulative_regret"][-1], 0.6)
